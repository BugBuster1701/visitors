...
<?php endif; ?>
			...
			<table cellspacing="0" cellpadding="0" class="mod_visitors_be_table_330" summary="Table lists online">
				...
				<tr>
				    ...
				    <td class="tl_folder_tlist" style="padding-left: 2px; text-align: right;"><?php echo $this->visitorsstatOnline[$vcid][0]; ?>&nbsp;</td>
				</tr>
				</tbody>
			</table>
        </div>
...
<?php if ($this->visitorsstatReferrer !== false) : ?>
	<?php foreach ($this->visitorsstatReferrer[$vcid] AS $Referrer) : ?>
			<tr>
			    ...
			    <td style="text-align: center;" class="tl_file_list"><?php if ($Referrer[2]) : ?><a onclick="Backend.openWindow(this, 746, 600); return false;" title="Details" href="<?php echo $this->visitors_base; ?>system/modules/visitors/ModuleVisitorReferrerDetails.php?tl_referrer=<?php echo $Referrer[0]; ?>&amp;tl_vid=<?php echo $Referrer[2]; ?>"><img width="16" height="16" alt="Details" src="system/themes/<?php echo $this->theme; ?>/images/show.gif"></a><?php endif; ?></td>
			</tr>
	<?php endforeach; ?>
			<tr>
